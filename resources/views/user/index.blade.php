        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                <div class="box-tools pull-right">
                    <a href="{{ route('app.user.import') }}" class="btn btn-sm btn-info rounded-0"><i class="fa fa-upload fa-sm"></i> Import</a>
                    <button type="button" class="btn btn-sm btn-primary rounded-0" onclick="showFormModal('New User', 'Save')"><i class="fa fa-plus fa-sm"></i> Add User</button>
                </div>
            </div>
            <div class="box-body">
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{ route('app.user.update-or-store') }}";
        ...
        $(document).on('click','.change_status', function(){
            ...
            var url = "{{ route('app.user.status-change') }}"
